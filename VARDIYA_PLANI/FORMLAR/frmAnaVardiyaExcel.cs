...
{
    public partial class frmAnaVardiyaExcel : Form
    {
        public frmAnaVardiyaExcel()
        {
            InitializeComponent();
        }

        private void frmAnaVardiyaListesi_Load(object sender, EventArgs e)
        {
            ...
            using (var connection = Database.GetConnection())
            {
                ...
                SqlCommand cmd = new SqlCommand("exec SP_VardiyaSaatleriAyarlama", baglanti);
