...
{
    public partial class frmMesaiPlanlamaEkrani : Form
    {
        public frmMesaiPlanlamaEkrani()
        {
            InitializeComponent();
        }
        ...
        private void frmMesaiPlanlamaEkrani_Load(object sender, EventArgs e)
        ...
        private void cmbBolum_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var connection = Database.GetConnection())
                {
                    ...
                    SqlCommand cmd = new SqlCommand("exec GunlukAnaVardiyaListesiAyarlama @Bolum", baglanti);
        ...
        private void btnGonder_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tabloPersonel.RowCount; i++)
            {
                ...
                else
                {
                    ...
                    if (islem.GunlukVardiyaEkleme(giris))
                    {
                    ...
                    else
                    {
                        ...
                        if (islem.GunlukVardiyaGuncelleme(giris))
                        {
